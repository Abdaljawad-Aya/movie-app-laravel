<div class="relative">
    <input wire:model.debounce.500ms="search" type="text" id="search-navbar" class="block p-2 pl-10 w-full text-gray-900 bg-blue-200
    ...
    @if (strlen($search) >= 2)
    <div class="absolute bg-blue-800 text-sm w-full mt-4">
