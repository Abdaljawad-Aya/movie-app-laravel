<div class="mt-8">
    ...
    <div class="mt-2">
        <a href="{{ route('movies.show', $popular['id']) }}" class="text-lg mt-2 hover:text-gray:300">{{ $popular['title'] }}</a>
        <div class="flex items-center text-gray-400 text-sm mt-1">
            <svg class="w-6 h-6 fill-current text-orange-500 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
