    ...
    <div class="container mx-auto px-12 py-16 flex flex-col md:flex-row">
        ...
        <div x-data="{isOpen: false}">
            ...
            <div class="mt-12">
                <button 
                        @click="isOpen = true"
                        class="flex inline-flex items-center bg-blue-500 text-white-900  font-semibold px-5 py-4 hover:bg-blue-600 transition ease-in-out duration-150">
                    ...
                    <div class="bg-blue-900 rounded">
                        ...
                        <div class="model-body px-8 py-8">
                            <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                                <iframe src="https://www.youtube.com/embed/{{ $popular['videos']['results'][0]['key'] }}"
